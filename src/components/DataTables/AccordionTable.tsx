...
const AccordionTable = () => {
  ...
  return (
    <div style={{ height: 535 }} className={'ag-theme-quartz-dark'}>
      <AgGridReact<any> rowData={rowData} columnDefs={columnDefs} defaultColDef={defaultColDef} masterDetail={true} detailCellRendererParams={detailCellRendererParams} onGridReady={onGridReady} />
    </div>
  );
};
