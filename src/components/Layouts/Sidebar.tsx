                ...
                <div className="bg-white dark:bg-black h-full">
                    <div className="flex justify-between items-center px-4 py-3">
                        <NavLink to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5 font-semibold align-middle lg:inline dark:text-white-light">Hybrix</span>
                        </NavLink>
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'dashboard' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NavLink to="/chart">{t('analytics')}</NavLink>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <NavLink to="/user-test">{t('test-user')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'approval' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('approval')}>
                                    <div className="flex items-center">
                                        <IconMenuDashboard className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('approval')}</span>
                                    </div>

                                    <div className={currentMenu !== 'approval' ? 'rtl:rotate-90 -rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'approval' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/approval">{t('approval')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
