                        ...
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/monitor" className="group">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('iamMonitor')}</span>
                                    </div>
                                </NavLink>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <NavLink to="/monitor" className="group">
                                    <div className="flex items-center">
                                        <IconMenuDragAndDrop className="group-hover:!text-primary shrink-0" />
                                        <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('iamAudit')}</span>
                                    </div>
                                </NavLink>
                            </li>
